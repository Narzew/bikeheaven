...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    /**
     * Default color of a {@link org.narzew.altimetr.RangeSeekBar}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (!selectedValuesAreDefault) {
			...
			Integer selected_min_number = (Integer)getSelectedMinValue();
			Integer selected_max_number = (Integer)getSelectedMaxValue();
			if(selected_min_number==1){
				minText="HC";
			} else if(selected_min_number==2){
				minText="1+";
			} else {
				minText=String.valueOf(selected_min_number-2);
			}
			if(selected_max_number==1){
				maxText="HC";
			} else if(selected_max_number==2){
				maxText="1+";
			} else {
				maxText=String.valueOf(selected_max_number-2);
			}
